...
Directly altering Babylon.js object properties via refss bypasses that overhead
and will be a more accurate animation smoothing. The reconciler will schedule
the updates using it's own algorithm, but this method will immediately apply the
update.
