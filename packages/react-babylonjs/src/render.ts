...
import Reconciler, {
  FiberRoot,
  Reconciler as ReconcilerType,
} from "react-reconciler";
import ReactBabylonJSHostConfig, {
  Container,
} from "./ReactBabylonJSHostConfig";
...
const ReconcilerPrimary: ReconcilerType<Container, any, any, any, any> =
  Reconciler({ ...ReactBabylonJSHostConfig, isPrimaryRenderer: true });
...
export function createPortal(
  ...
  const reconciler =
    usePrimary === true ? ReconcilerPrimary : ReconcilerSecondary;
...
export function createReconciler(
  ...
  const reconciler: ReconcilerType<Container, any, any, any, any> =
    rendererOptions.usePrimary === true
      ? ReconcilerPrimary
      : ReconcilerSecondary;
