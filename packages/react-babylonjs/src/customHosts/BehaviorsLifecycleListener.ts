import {
  Behavior,
  IBehaviorAware,
} from "@babylonjs/core/Behaviors/behavior.js";
import { Nullable } from "@babylonjs/core/types.js";
import { CreatedInstance } from "../CreatedInstance";
import BaseLifecycleListener from "./BaseLifecycleListener";

export default class BehaviorLifecycleListener extends BaseLifecycleListener<
  Behavior<any>,
  any
> {
  ...
  onParented(parent: CreatedInstance<any>, child: CreatedInstance<any>) {
    ...
    if (
      ...
      parent.hostInstance
        ?.addBehavior /* TODO: verify if this needs to be a mesh */ &&
