...
export default class AdvancedDynamicTexture extends GUI2DSceneComponent<BabylonAdvancedDynamicTexture, BabylonAdvancedDynamicTexture, AdvancedDynamicTextureProps> {
    ...
    create(scene: Scene): BabylonAdvancedDynamicTexture {
        this.advancedDynamicTexture = (this.props.createForParentMesh === true)
            ? BabylonAdvancedDynamicTexture.CreateForMesh(this.props.container.babylonObject)
            : new BabylonAdvancedDynamicTexture(this.props.name, this.props.width, this.props.height, scene, this.props.generateMipMaps, this.props.samplingMode);
    ...
    public get propsHandlers() {
        return [ /* TODO: create a GUI Container props handler */]
    }
}
