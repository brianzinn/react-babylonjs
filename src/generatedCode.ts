...
export const AnaglyphArcRotateCamera: string = "AnaglyphArcRotateCamera",
  ...
  HDRCubeTextureAssetTask: string = "HDRCubeTextureAssetTask",
  HemisphericLight: string = "HemisphericLight",
  IcoSphere: string = "IcoSphere",
  InternalTexture: string = "InternalTexture",
  KhronosTextureContainer: string = "KhronosTextureContainer",
  Lathe: string = "Lathe",
  Light: string = "Light",
  LineSystem: string = "LineSystem",
  Lines: string = "Lines",
  Material: string = "Material",
  MaterialHelper: string = "MaterialHelper",
  Mesh: string = "Mesh",
  ...
  PositionNormalTextureVertex: string = "PositionNormalTextureVertex",
  ProceduralTexture: string = "ProceduralTexture",
  ProceduralTextureSceneComponent: string = "ProceduralTextureSceneComponent",
  ...
  SpriteSceneComponent: string = "SpriteSceneComponent",
  ...
  TextureAssetTask: string = "TextureAssetTask",
  TextureOptimization: string = "TextureOptimization",
  TextureTools: string = "TextureTools",
  ...
  VRCameraMetrics: string = "VRCameraMetrics",
