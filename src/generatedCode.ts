...
export class FiberAdvancedDynamicTexture implements HasPropsHandlers<BabylonjsCoreBaseTexture, FiberBaseTextureProps> {
    ...
    public static readonly CreateInfo = {
        ...
        "namespace": "@babylonjs/gui/2D/advancedDynamicTexture",
        "parameters": [
            {
                "name": "name",
                "type": "string",
