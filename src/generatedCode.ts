...
export class FiberAbstractMeshPropsHandler implements PropsHandler<BABYLON.AbstractMesh, FiberAbstractMeshProps> {
  getPropertyUpdates(
    ...
    if (
      newProps.edgesColor &&
      (!oldProps.edgesColor ||
        oldProps.edgesColor.r !== newProps.edgesColor.r ||
        oldProps.edgesColor.g !== newProps.edgesColor.g ||
        oldProps.edgesColor.b !== newProps.edgesColor.b ||
        oldProps.edgesColor.a !== newProps.edgesColor.a)
    ) {
      updates.push({
...
export class FiberRenderTargetTexturePropsHandler implements PropsHandler<BABYLON.RenderTargetTexture, FiberRenderTargetTextureProps> {
  getPropertyUpdates(
    ...
    if (
      newProps.clearColor &&
      (!oldProps.clearColor ||
        oldProps.clearColor.r !== newProps.clearColor.r ||
        oldProps.clearColor.g !== newProps.clearColor.g ||
        oldProps.clearColor.b !== newProps.clearColor.b ||
        oldProps.clearColor.a !== newProps.clearColor.a)
    ) {
      updates.push({
...
export const DynamicTerrain: string = "DynamicTerrain",
