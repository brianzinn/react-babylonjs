...
export class FiberTransformNodePropsHandler implements PropsHandler<BABYLON.TransformNode, FiberTransformNodeProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.TransformNode,
    ...
    if (
      oldProps.onAfterWorldMatrixUpdateObservable === undefined &&
      oldProps.onAfterWorldMatrixUpdateObservable !== newProps.onAfterWorldMatrixUpdateObservable
    ) {
      updates.push({
...
export class FiberAbstractMeshPropsHandler implements PropsHandler<BABYLON.AbstractMesh, FiberAbstractMeshProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.AbstractMesh,
    ...
    if (
      oldProps.onCollisionPositionChangeObservable === undefined &&
      oldProps.onCollisionPositionChangeObservable !== newProps.onCollisionPositionChangeObservable
    ) {
      updates.push({
...
export class FiberAbstractMesh implements HasPropsHandlers<BABYLON.TransformNode, FiberTransformNodeProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberAbstractMeshPropsHandler(), new FiberTransformNodePropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberMesh implements HasPropsHandlers<BABYLON.AbstractMesh, FiberAbstractMeshProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberMeshPropsHandler(), new FiberAbstractMeshPropsHandler(), new FiberTransformNodePropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberCameraPropsHandler implements PropsHandler<BABYLON.Camera, FiberCameraProps> {
  getPropertyUpdates(hostInstance: BABYLON.Camera, oldProps: FiberCameraProps, newProps: FiberCameraProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    if (
      oldProps.onProjectionMatrixChangedObservable === undefined &&
      oldProps.onProjectionMatrixChangedObservable !== newProps.onProjectionMatrixChangedObservable
    ) {
      updates.push({
...
export class FiberTargetCameraPropsHandler implements PropsHandler<BABYLON.TargetCamera, FiberTargetCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.TargetCamera,
...
export class FiberTargetCamera implements HasPropsHandlers<BABYLON.Camera, FiberCameraProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberTargetCameraPropsHandler(), new FiberCameraPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberArcRotateCameraPropsHandler implements PropsHandler<BABYLON.ArcRotateCamera, FiberArcRotateCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ArcRotateCamera,
...
export class FiberAnaglyphArcRotateCameraPropsHandler implements PropsHandler<BABYLON.AnaglyphArcRotateCamera, FiberAnaglyphArcRotateCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.AnaglyphArcRotateCamera,
...
export class FiberStereoscopicArcRotateCameraPropsHandler implements PropsHandler<BABYLON.StereoscopicArcRotateCamera, FiberStereoscopicArcRotateCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.StereoscopicArcRotateCamera,
...
export class FiberVRDeviceOrientationArcRotateCameraPropsHandler
  implements PropsHandler<BABYLON.VRDeviceOrientationArcRotateCamera, FiberVRDeviceOrientationArcRotateCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VRDeviceOrientationArcRotateCamera,
...
export class FiberFlyCameraPropsHandler implements PropsHandler<BABYLON.FlyCamera, FiberFlyCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.FlyCamera,
...
export class FiberFlyCamera implements HasPropsHandlers<BABYLON.Camera, FiberCameraProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberFlyCameraPropsHandler(), new FiberTargetCameraPropsHandler(), new FiberCameraPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberFollowCameraPropsHandler implements PropsHandler<BABYLON.FollowCamera, FiberFollowCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.FollowCamera,
...
export class FiberFollowCamera implements HasPropsHandlers<BABYLON.Camera, FiberCameraProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberFollowCameraPropsHandler(), new FiberTargetCameraPropsHandler(), new FiberCameraPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberArcFollowCameraPropsHandler implements PropsHandler<BABYLON.ArcFollowCamera, FiberArcFollowCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ArcFollowCamera,
...
export class FiberFreeCameraPropsHandler implements PropsHandler<BABYLON.FreeCamera, FiberFreeCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.FreeCamera,
...
export class FiberFreeCamera implements HasPropsHandlers<BABYLON.Camera, FiberCameraProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberFreeCameraPropsHandler(), new FiberTargetCameraPropsHandler(), new FiberCameraPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberDeviceOrientationCameraPropsHandler implements PropsHandler<BABYLON.DeviceOrientationCamera, FiberDeviceOrientationCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.DeviceOrientationCamera,
...
export class FiberVRDeviceOrientationFreeCameraPropsHandler
  implements PropsHandler<BABYLON.VRDeviceOrientationFreeCamera, FiberVRDeviceOrientationFreeCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VRDeviceOrientationFreeCamera,
...
export class FiberVRDeviceOrientationGamepadCameraPropsHandler
  implements PropsHandler<BABYLON.VRDeviceOrientationGamepadCamera, FiberVRDeviceOrientationGamepadCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VRDeviceOrientationGamepadCamera,
...
export class FiberTouchCameraPropsHandler implements PropsHandler<BABYLON.TouchCamera, FiberTouchCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.TouchCamera,
...
export class FiberUniversalCameraPropsHandler implements PropsHandler<BABYLON.UniversalCamera, FiberUniversalCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.UniversalCamera,
...
export class FiberGamepadCameraPropsHandler implements PropsHandler<BABYLON.GamepadCamera, FiberGamepadCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.GamepadCamera,
...
export class FiberAnaglyphGamepadCameraPropsHandler implements PropsHandler<BABYLON.AnaglyphGamepadCamera, FiberAnaglyphGamepadCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.AnaglyphGamepadCamera,
...
export class FiberStereoscopicGamepadCameraPropsHandler implements PropsHandler<BABYLON.StereoscopicGamepadCamera, FiberStereoscopicGamepadCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.StereoscopicGamepadCamera,
...
export class FiberAnaglyphUniversalCameraPropsHandler implements PropsHandler<BABYLON.AnaglyphUniversalCamera, FiberAnaglyphUniversalCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.AnaglyphUniversalCamera,
...
export class FiberStereoscopicUniversalCameraPropsHandler implements PropsHandler<BABYLON.StereoscopicUniversalCamera, FiberStereoscopicUniversalCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.StereoscopicUniversalCamera,
...
export class FiberVirtualJoysticksCameraPropsHandler implements PropsHandler<BABYLON.VirtualJoysticksCamera, FiberVirtualJoysticksCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VirtualJoysticksCamera,
...
export class FiberAnaglyphFreeCameraPropsHandler implements PropsHandler<BABYLON.AnaglyphFreeCamera, FiberAnaglyphFreeCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.AnaglyphFreeCamera,
...
export class FiberStereoscopicFreeCameraPropsHandler implements PropsHandler<BABYLON.StereoscopicFreeCamera, FiberStereoscopicFreeCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.StereoscopicFreeCamera,
...
export class FiberWebVRFreeCameraPropsHandler implements PropsHandler<BABYLON.WebVRFreeCamera, FiberWebVRFreeCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.WebVRFreeCamera,
...
export class FiberWebXRCameraPropsHandler implements PropsHandler<BABYLON.WebXRCamera, FiberWebXRCameraProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.WebXRCamera,
...
export class FiberMultiMaterialPropsHandler implements PropsHandler<BABYLON.MultiMaterial, FiberMultiMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.MultiMaterial,
...
export class FiberPushMaterialPropsHandler implements PropsHandler<BABYLON.PushMaterial, FiberPushMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PushMaterial,
...
export class FiberStandardMaterialPropsHandler implements PropsHandler<BABYLON.StandardMaterial, FiberStandardMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.StandardMaterial,
...
export class FiberStandardMaterial implements HasPropsHandlers<BABYLON.Material, FiberMaterialProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberStandardMaterialPropsHandler(), new FiberPushMaterialPropsHandler(), new FiberMaterialPropsHandler()]
  }
...
export class FiberBackgroundMaterialPropsHandler implements PropsHandler<BABYLON.BackgroundMaterial, FiberBackgroundMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.BackgroundMaterial,
...
export class FiberBackgroundMaterial implements HasPropsHandlers<BABYLON.Material, FiberMaterialProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberBackgroundMaterialPropsHandler(), new FiberPushMaterialPropsHandler(), new FiberMaterialPropsHandler()]
  }
...
export class FiberPBRBaseMaterialPropsHandler implements PropsHandler<BABYLON.PBRBaseMaterial, FiberPBRBaseMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PBRBaseMaterial,
...
export class FiberPBRBaseMaterial implements HasPropsHandlers<BABYLON.Material, FiberMaterialProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberPBRBaseMaterialPropsHandler(), new FiberPushMaterialPropsHandler(), new FiberMaterialPropsHandler()]
  }
...
export class FiberPBRBaseSimpleMaterialPropsHandler implements PropsHandler<BABYLON.PBRBaseSimpleMaterial, FiberPBRBaseSimpleMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PBRBaseSimpleMaterial,
...
export class FiberPBRMetallicRoughnessMaterialPropsHandler
  implements PropsHandler<BABYLON.PBRMetallicRoughnessMaterial, FiberPBRMetallicRoughnessMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PBRMetallicRoughnessMaterial,
...
export class FiberPBRSpecularGlossinessMaterialPropsHandler
  implements PropsHandler<BABYLON.PBRSpecularGlossinessMaterial, FiberPBRSpecularGlossinessMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PBRSpecularGlossinessMaterial,
...
export class FiberPBRMaterialPropsHandler implements PropsHandler<BABYLON.PBRMaterial, FiberPBRMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PBRMaterial,
...
export class FiberShaderMaterialPropsHandler implements PropsHandler<BABYLON.ShaderMaterial, FiberShaderMaterialProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ShaderMaterial,
...
export class FiberHemisphericLightPropsHandler implements PropsHandler<BABYLON.HemisphericLight, FiberHemisphericLightProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.HemisphericLight,
...
export class FiberHemisphericLight implements HasPropsHandlers<BABYLON.Light, FiberLightProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberHemisphericLightPropsHandler(), new FiberLightPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberShadowLightPropsHandler implements PropsHandler<BABYLON.ShadowLight, FiberShadowLightProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ShadowLight,
...
export class FiberShadowLight implements HasPropsHandlers<BABYLON.Light, FiberLightProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberShadowLightPropsHandler(), new FiberLightPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberDirectionalLightPropsHandler implements PropsHandler<BABYLON.DirectionalLight, FiberDirectionalLightProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.DirectionalLight,
...
export class FiberPointLightPropsHandler implements PropsHandler<BABYLON.PointLight, FiberPointLightProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.PointLight,
...
export class FiberPointLight implements HasPropsHandlers<BABYLON.Light, FiberLightProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberPointLightPropsHandler(), new FiberShadowLightPropsHandler(), new FiberLightPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberSpotLightPropsHandler implements PropsHandler<BABYLON.SpotLight, FiberSpotLightProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.SpotLight,
    ...
    if (
      ...
      (!oldProps.projectionTextureUpDirection || !oldProps.projectionTextureUpDirection.equals(newProps.projectionTextureUpDirection))
    ) {
      updates.push({
...
export class FiberSpotLight implements HasPropsHandlers<BABYLON.Light, FiberLightProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberSpotLightPropsHandler(), new FiberShadowLightPropsHandler(), new FiberLightPropsHandler(), new FiberNodePropsHandler()]
  }
...
export class FiberControlPropsHandler implements PropsHandler<GUI.Control, FiberControlProps> {
  getPropertyUpdates(hostInstance: GUI.Control, oldProps: FiberControlProps, newProps: FiberControlProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    // GUI.Control.useBitmapCache of type 'boolean':
...
export class FiberEllipse implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberEllipsePropsHandler(), new FiberContainerPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberGrid implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberGridPropsHandler(), new FiberContainerPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberStackPanel implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberStackPanelPropsHandler(), new FiberContainerPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberVirtualKeyboardPropsHandler implements PropsHandler<GUI.VirtualKeyboard, FiberVirtualKeyboardProps> {
  getPropertyUpdates(
    hostInstance: GUI.VirtualKeyboard,
...
export class FiberRectangle implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberRectanglePropsHandler(), new FiberContainerPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberButton implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberButtonPropsHandler(), new FiberRectanglePropsHandler(), new FiberContainerPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberSelectionPanelPropsHandler implements PropsHandler<GUI.SelectionPanel, FiberSelectionPanelProps> {
  getPropertyUpdates(
    hostInstance: GUI.SelectionPanel,
...
export class FiberImagePropsHandler implements PropsHandler<GUI.Image, FiberImageProps> {
  getPropertyUpdates(hostInstance: GUI.Image, oldProps: FiberImageProps, newProps: FiberImageProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    // GUI.Image.populateNinePatchSlicesFromImage of type 'boolean':
    ...
    // GUI.Image.sliceBottom of type 'number':
    ...
    // GUI.Image.sliceLeft of type 'number':
    ...
    // GUI.Image.sliceRight of type 'number':
    ...
    // GUI.Image.sliceTop of type 'number':
...
export class FiberInputTextPropsHandler implements PropsHandler<GUI.InputText, FiberInputTextProps> {
  getPropertyUpdates(hostInstance: GUI.InputText, oldProps: FiberInputTextProps, newProps: FiberInputTextProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    // GUI.InputText.focusedColor of type 'string':
    ...
    // GUI.InputText.onKeyboardEventProcessedObservable of type 'BABYLON.Observable<KeyboardEvent>/fn':
    if (
      oldProps.onKeyboardEventProcessedObservable === undefined &&
      oldProps.onKeyboardEventProcessedObservable !== newProps.onKeyboardEventProcessedObservable
    ) {
      updates.push({
        propertyName: "onKeyboardEventProcessedObservable",
        value: newProps.onKeyboardEventProcessedObservable,
        type: "BABYLON.Observable<KeyboardEvent>"
      })
    }
...
export class FiberInputPasswordPropsHandler implements PropsHandler<GUI.InputPassword, FiberInputPasswordProps> {
  getPropertyUpdates(
    hostInstance: GUI.InputPassword,
...
export class FiberInputPassword implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberInputPasswordPropsHandler(), new FiberInputTextPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberSliderPropsHandler implements PropsHandler<GUI.Slider, FiberSliderProps> {
  getPropertyUpdates(hostInstance: GUI.Slider, oldProps: FiberSliderProps, newProps: FiberSliderProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    // GUI.Slider.displayValueBar of type 'boolean':
...
export class FiberSlider implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberSliderPropsHandler(), new FiberBaseSliderPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberImageBasedSliderPropsHandler implements PropsHandler<GUI.ImageBasedSlider, FiberImageBasedSliderProps> {
  getPropertyUpdates(
    hostInstance: GUI.ImageBasedSlider,
...
export class FiberImageBasedSlider implements HasPropsHandlers<GUI.Control, FiberControlProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberImageBasedSliderPropsHandler(), new FiberBaseSliderPropsHandler(), new FiberControlPropsHandler()]
  }
...
export class FiberAbstractButton3DPropsHandler implements PropsHandler<GUI.AbstractButton3D, FiberAbstractButton3DProps> {
  getPropertyUpdates(
    hostInstance: GUI.AbstractButton3D,
...
export class FiberButton3D implements HasPropsHandlers<GUI.Control3D, FiberControl3DProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberButton3DPropsHandler(), new FiberAbstractButton3DPropsHandler(), new FiberControl3DPropsHandler()]
  }
...
export class FiberHolographicButtonPropsHandler implements PropsHandler<GUI.HolographicButton, FiberHolographicButtonProps> {
  getPropertyUpdates(
    hostInstance: GUI.HolographicButton,
...
export class FiberStackPanel3D implements HasPropsHandlers<GUI.Control3D, FiberControl3DProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberStackPanel3DPropsHandler(), new FiberContainer3DPropsHandler(), new FiberControl3DPropsHandler()]
  }
...
export class FiberVolumeBasedPanelPropsHandler implements PropsHandler<GUI.VolumeBasedPanel, FiberVolumeBasedPanelProps> {
  getPropertyUpdates(
    hostInstance: GUI.VolumeBasedPanel,
...
export class FiberVolumeBasedPanel implements HasPropsHandlers<GUI.Control3D, FiberControl3DProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberVolumeBasedPanelPropsHandler(), new FiberContainer3DPropsHandler(), new FiberControl3DPropsHandler()]
  }
...
export class FiberCylinderPanelPropsHandler implements PropsHandler<GUI.CylinderPanel, FiberCylinderPanelProps> {
  getPropertyUpdates(
    hostInstance: GUI.CylinderPanel,
...
export class FiberBaseTexturePropsHandler implements PropsHandler<BABYLON.BaseTexture, FiberBaseTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.BaseTexture,
...
export class FiberBaseTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberBaseTexturePropsHandler()]
  }
...
export class FiberColorGradingTexturePropsHandler implements PropsHandler<BABYLON.ColorGradingTexture, FiberColorGradingTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ColorGradingTexture,
...
export class FiberColorGradingTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberColorGradingTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberCubeTexturePropsHandler implements PropsHandler<BABYLON.CubeTexture, FiberCubeTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.CubeTexture,
...
export class FiberCubeTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberCubeTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberRawCubeTexturePropsHandler implements PropsHandler<BABYLON.RawCubeTexture, FiberRawCubeTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.RawCubeTexture,
...
export class FiberRawCubeTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberRawCubeTexturePropsHandler(), new FiberCubeTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberHDRCubeTexturePropsHandler implements PropsHandler<BABYLON.HDRCubeTexture, FiberHDRCubeTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.HDRCubeTexture,
...
export class FiberHDRCubeTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberHDRCubeTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberDynamicTexturePropsHandler implements PropsHandler<BABYLON.DynamicTexture, FiberDynamicTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.DynamicTexture,
...
export class FiberDynamicTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberDynamicTexturePropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberRawTexturePropsHandler implements PropsHandler<BABYLON.RawTexture, FiberRawTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.RawTexture,
...
export class FiberRawTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberRawTexturePropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberRawTexture3DPropsHandler implements PropsHandler<BABYLON.RawTexture3D, FiberRawTexture3DProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.RawTexture3D,
...
export class FiberRawTexture3D implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberRawTexture3DPropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberRenderTargetTexturePropsHandler implements PropsHandler<BABYLON.RenderTargetTexture, FiberRenderTargetTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.RenderTargetTexture,
    ...
    if (oldProps.setRenderingOrder !== newProps.setRenderingOrder) {
      updates.push({
        ...
        type:
          "(renderingGroupId?: number, opaqueSortCompareFn?: (a: BABYLON.SubMesh, b: BABYLON.SubMesh) => number, alphaTestSortCompareFn?: (a: BABYLON.SubMesh, b: BABYLON.SubMesh) => number, transparentSortCompareFn?: (a: BABYLON.SubMesh, b: BABYLON.SubMesh) => number)"
      })
    }
    return updates.length == 0 ? null : updates
  }
...
export class FiberRenderTargetTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberRenderTargetTexturePropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberMirrorTexturePropsHandler implements PropsHandler<BABYLON.MirrorTexture, FiberMirrorTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.MirrorTexture,
...
export class FiberMultiRenderTargetPropsHandler implements PropsHandler<BABYLON.MultiRenderTarget, FiberMultiRenderTargetProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.MultiRenderTarget,
...
export class FiberRefractionTexturePropsHandler implements PropsHandler<BABYLON.RefractionTexture, FiberRefractionTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.RefractionTexture,
...
export class FiberVideoTexturePropsHandler implements PropsHandler<BABYLON.VideoTexture, FiberVideoTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VideoTexture,
...
export class FiberVideoTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberVideoTexturePropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberProceduralTexturePropsHandler implements PropsHandler<BABYLON.ProceduralTexture, FiberProceduralTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ProceduralTexture,
...
export class FiberProceduralTexture implements HasPropsHandlers<BABYLON.BaseTexture, FiberBaseTextureProps> {
  ...
  constructor() {
    this.propsHandlers = [new FiberProceduralTexturePropsHandler(), new FiberTexturePropsHandler(), new FiberBaseTexturePropsHandler()]
  }
...
export class FiberCustomProceduralTexturePropsHandler implements PropsHandler<BABYLON.CustomProceduralTexture, FiberCustomProceduralTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.CustomProceduralTexture,
...
export class FiberNoiseProceduralTexturePropsHandler implements PropsHandler<BABYLON.NoiseProceduralTexture, FiberNoiseProceduralTextureProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.NoiseProceduralTexture,
...
export class FiberAdvancedDynamicTextureProps extends FiberDynamicTextureProps {
  ...
  onBeginLayoutObservable?: BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>
  onBeginRenderObservable?: BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>
  ...
  onEndLayoutObservable?: BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>
  onEndRenderObservable?: BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>
  premulAlpha?: boolean
...
export class FiberAdvancedDynamicTexturePropsHandler implements PropsHandler<GUI.AdvancedDynamicTexture, FiberAdvancedDynamicTextureProps> {
  getPropertyUpdates(
    hostInstance: GUI.AdvancedDynamicTexture,
    ...
    // GUI.AdvancedDynamicTexture.onBeginLayoutObservable of type 'BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>/fn':
    if (oldProps.onBeginLayoutObservable === undefined && oldProps.onBeginLayoutObservable !== newProps.onBeginLayoutObservable) {
      updates.push({
        ...
        type: "BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>"
      })
    }
    // GUI.AdvancedDynamicTexture.onBeginRenderObservable of type 'BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>/fn':
    ...
    // GUI.AdvancedDynamicTexture.onEndLayoutObservable of type 'BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>/fn':
    ...
    // GUI.AdvancedDynamicTexture.onEndRenderObservable of type 'BABYLON.Observable<BABYLON.GUI.AdvancedDynamicTexture>/fn':
    ...
    // GUI.AdvancedDynamicTexture.useInvalidateRectOptimization of type 'boolean':
...
export class FiberShadowGeneratorPropsHandler implements PropsHandler<BABYLON.ShadowGenerator, FiberShadowGeneratorProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.ShadowGenerator,
...
export class FiberEnvironmentHelperPropsHandler implements PropsHandler<BABYLON.EnvironmentHelper, FiberEnvironmentHelperProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.EnvironmentHelper,
...
export class FiberVRExperienceHelperPropsHandler implements PropsHandler<BABYLON.VRExperienceHelper, FiberVRExperienceHelperProps> {
  getPropertyUpdates(
    hostInstance: BABYLON.VRExperienceHelper,
    ...
    // BABYLON.VRExperienceHelper.updateGazeTrackerColor of type 'boolean':
...
export class FiberScenePropsHandler implements PropsHandler<BABYLON.Scene, FiberSceneProps> {
  getPropertyUpdates(hostInstance: BABYLON.Scene, oldProps: FiberSceneProps, newProps: FiberSceneProps, scene: BABYLON.Scene): PropertyUpdate[] | null {
    ...
    // TODO: type: any property (not coded) BABYLON.Scene.geometriesByUniqueId.
    ...
    if (
      oldProps.onAfterActiveMeshesEvaluationObservable === undefined &&
      oldProps.onAfterActiveMeshesEvaluationObservable !== newProps.onAfterActiveMeshesEvaluationObservable
    ) {
      updates.push({
    ...
    if (
      oldProps.onAfterParticlesRenderingObservable === undefined &&
      oldProps.onAfterParticlesRenderingObservable !== newProps.onAfterParticlesRenderingObservable
    ) {
      updates.push({
    ...
    if (
      oldProps.onAfterRenderTargetsRenderObservable === undefined &&
      oldProps.onAfterRenderTargetsRenderObservable !== newProps.onAfterRenderTargetsRenderObservable
    ) {
      updates.push({
    ...
    if (
      oldProps.onBeforeActiveMeshesEvaluationObservable === undefined &&
      oldProps.onBeforeActiveMeshesEvaluationObservable !== newProps.onBeforeActiveMeshesEvaluationObservable
    ) {
      updates.push({
    ...
    if (
      oldProps.onBeforeParticlesRenderingObservable === undefined &&
      oldProps.onBeforeParticlesRenderingObservable !== newProps.onBeforeParticlesRenderingObservable
    ) {
      updates.push({
    ...
    if (
      oldProps.onBeforeRenderTargetsRenderObservable === undefined &&
      oldProps.onBeforeRenderTargetsRenderObservable !== newProps.onBeforeRenderTargetsRenderObservable
    ) {
      updates.push({
...
export const AbstractButton3D: string = "AbstractButton3D",
