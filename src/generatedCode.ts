...
export interface PropsHandler<T, U> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<T>,
    oldProps: U,
    newProps: U,
    scene: BABYLON.Scene
  ): PropertyUpdate[] | null
...
export class FiberNodePropsHandler implements PropsHandler<BABYLON.Node, FiberNodeProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.Node>,
...
export class FiberCameraPropsHandler implements PropsHandler<BABYLON.Camera, FiberCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.Camera>,
...
export class FiberTargetCameraPropsHandler implements PropsHandler<BABYLON.TargetCamera, FiberTargetCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.TargetCamera>,
    ...
    if (
      ...
      (!oldProps.cameraDirection || !oldProps.cameraDirection.equals(newProps.cameraDirection))
    ) {
      updates.push({
...
export class FiberArcRotateCameraPropsHandler
  implements PropsHandler<BABYLON.ArcRotateCamera, FiberArcRotateCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.ArcRotateCamera>,
    ...
    if (
      ...
      (!oldProps.collisionRadius || !oldProps.collisionRadius.equals(newProps.collisionRadius))
    ) {
      updates.push({
    ...
    if (
      ...
      (!oldProps.panningOriginTarget || !oldProps.panningOriginTarget.equals(newProps.panningOriginTarget))
    ) {
      updates.push({
...
export class FiberAnaglyphArcRotateCameraPropsHandler
  implements PropsHandler<BABYLON.AnaglyphArcRotateCamera, FiberAnaglyphArcRotateCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.AnaglyphArcRotateCamera>,
...
export class FiberStereoscopicArcRotateCameraPropsHandler
  implements PropsHandler<BABYLON.StereoscopicArcRotateCamera, FiberStereoscopicArcRotateCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.StereoscopicArcRotateCamera>,
...
export class FiberVRDeviceOrientationArcRotateCameraPropsHandler
  ...
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.VRDeviceOrientationArcRotateCamera>,
...
export class FiberFollowCameraPropsHandler implements PropsHandler<BABYLON.FollowCamera, FiberFollowCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.FollowCamera>,
...
export class FiberArcFollowCameraPropsHandler
  implements PropsHandler<BABYLON.ArcFollowCamera, FiberArcFollowCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.ArcFollowCamera>,
...
export class FiberFreeCameraPropsHandler implements PropsHandler<BABYLON.FreeCamera, FiberFreeCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.FreeCamera>,
    ...
    if (
      ...
      (!oldProps.ellipsoidOffset || !oldProps.ellipsoidOffset.equals(newProps.ellipsoidOffset))
    ) {
      updates.push({
...
export class FiberDeviceOrientationCameraPropsHandler
  implements PropsHandler<BABYLON.DeviceOrientationCamera, FiberDeviceOrientationCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.DeviceOrientationCamera>,
...
export class FiberVRDeviceOrientationFreeCameraPropsHandler
  ...
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.VRDeviceOrientationFreeCamera>,
...
export class FiberVRDeviceOrientationGamepadCameraPropsHandler
  ...
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.VRDeviceOrientationGamepadCamera>,
...
export class FiberTouchCameraPropsHandler implements PropsHandler<BABYLON.TouchCamera, FiberTouchCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.TouchCamera>,
...
export class FiberUniversalCameraPropsHandler
  implements PropsHandler<BABYLON.UniversalCamera, FiberUniversalCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.UniversalCamera>,
...
export class FiberGamepadCameraPropsHandler implements PropsHandler<BABYLON.GamepadCamera, FiberGamepadCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.GamepadCamera>,
...
export class FiberAnaglyphGamepadCameraPropsHandler
  implements PropsHandler<BABYLON.AnaglyphGamepadCamera, FiberAnaglyphGamepadCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.AnaglyphGamepadCamera>,
...
export class FiberStereoscopicGamepadCameraPropsHandler
  implements PropsHandler<BABYLON.StereoscopicGamepadCamera, FiberStereoscopicGamepadCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.StereoscopicGamepadCamera>,
...
export class FiberAnaglyphUniversalCameraPropsHandler
  implements PropsHandler<BABYLON.AnaglyphUniversalCamera, FiberAnaglyphUniversalCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.AnaglyphUniversalCamera>,
...
export class FiberStereoscopicUniversalCameraPropsHandler
  implements PropsHandler<BABYLON.StereoscopicUniversalCamera, FiberStereoscopicUniversalCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.StereoscopicUniversalCamera>,
...
export class FiberVirtualJoysticksCameraPropsHandler
  implements PropsHandler<BABYLON.VirtualJoysticksCamera, FiberVirtualJoysticksCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.VirtualJoysticksCamera>,
...
export class FiberAnaglyphFreeCameraPropsHandler
  implements PropsHandler<BABYLON.AnaglyphFreeCamera, FiberAnaglyphFreeCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.AnaglyphFreeCamera>,
...
export class FiberStereoscopicFreeCameraPropsHandler
  implements PropsHandler<BABYLON.StereoscopicFreeCamera, FiberStereoscopicFreeCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.StereoscopicFreeCamera>,
...
export class FiberWebVRFreeCameraPropsHandler
  implements PropsHandler<BABYLON.WebVRFreeCamera, FiberWebVRFreeCameraProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.WebVRFreeCamera>,
    ...
    if (
      ...
      (!oldProps.devicePosition || !oldProps.devicePosition.equals(newProps.devicePosition))
    ) {
      updates.push({
...
export class FiberMeshPropsHandler implements PropsHandler<BABYLON.Mesh, FiberMeshProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.Mesh>,
    ...
    if (
      ...
      (!oldProps.facetDepthSortFrom || !oldProps.facetDepthSortFrom.equals(newProps.facetDepthSortFrom))
    ) {
      updates.push({
...
export class FiberMaterialPropsHandler implements PropsHandler<BABYLON.Material, FiberMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.Material>,
...
export class FiberMultiMaterialPropsHandler implements PropsHandler<BABYLON.MultiMaterial, FiberMultiMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.MultiMaterial>,
...
export class FiberPushMaterialPropsHandler implements PropsHandler<BABYLON.PushMaterial, FiberPushMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PushMaterial>,
...
export class FiberStandardMaterialPropsHandler
  implements PropsHandler<BABYLON.StandardMaterial, FiberStandardMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.StandardMaterial>,
...
export class FiberBackgroundMaterialPropsHandler
  implements PropsHandler<BABYLON.BackgroundMaterial, FiberBackgroundMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.BackgroundMaterial>,
...
export class FiberPBRBaseMaterialPropsHandler
  implements PropsHandler<BABYLON.PBRBaseMaterial, FiberPBRBaseMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PBRBaseMaterial>,
...
export class FiberPBRBaseSimpleMaterialPropsHandler
  implements PropsHandler<BABYLON.PBRBaseSimpleMaterial, FiberPBRBaseSimpleMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PBRBaseSimpleMaterial>,
...
export class FiberPBRMetallicRoughnessMaterialPropsHandler
  ...
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PBRMetallicRoughnessMaterial>,
...
export class FiberPBRSpecularGlossinessMaterialPropsHandler
  ...
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PBRSpecularGlossinessMaterial>,
...
export class FiberPBRMaterialPropsHandler implements PropsHandler<BABYLON.PBRMaterial, FiberPBRMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PBRMaterial>,
    ...
    if (
      ...
      (!oldProps.reflectionColor || !oldProps.reflectionColor.equals(newProps.reflectionColor))
    ) {
      updates.push({
    ...
    if (
      ...
      (!oldProps.reflectivityColor || !oldProps.reflectivityColor.equals(newProps.reflectivityColor))
    ) {
      updates.push({
...
export class FiberShaderMaterialPropsHandler implements PropsHandler<BABYLON.ShaderMaterial, FiberShaderMaterialProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.ShaderMaterial>,
...
export class FiberLightPropsHandler implements PropsHandler<BABYLON.Light, FiberLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.Light>,
...
export class FiberHemisphericLightPropsHandler
  implements PropsHandler<BABYLON.HemisphericLight, FiberHemisphericLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.HemisphericLight>,
...
export class FiberShadowLightPropsHandler implements PropsHandler<BABYLON.ShadowLight, FiberShadowLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.ShadowLight>,
    ...
    if (
      ...
      (!oldProps.transformedDirection || !oldProps.transformedDirection.equals(newProps.transformedDirection))
    ) {
      updates.push({
    ...
    if (
      ...
      (!oldProps.transformedPosition || !oldProps.transformedPosition.equals(newProps.transformedPosition))
    ) {
      updates.push({
...
export class FiberDirectionalLightPropsHandler
  implements PropsHandler<BABYLON.DirectionalLight, FiberDirectionalLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.DirectionalLight>,
...
export class FiberPointLightPropsHandler implements PropsHandler<BABYLON.PointLight, FiberPointLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.PointLight>,
...
export class FiberSpotLightPropsHandler implements PropsHandler<BABYLON.SpotLight, FiberSpotLightProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<BABYLON.SpotLight>,
    ...
    if (
      ...
      (!oldProps.projectionTextureUpDirection ||
        !oldProps.projectionTextureUpDirection.equals(newProps.projectionTextureUpDirection))
    ) {
      updates.push({
...
export class FiberControlPropsHandler implements PropsHandler<GUI.Control, FiberControlProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Control>,
...
export class FiberCheckboxPropsHandler implements PropsHandler<GUI.Checkbox, FiberCheckboxProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Checkbox>,
...
export class FiberColorPickerPropsHandler implements PropsHandler<GUI.ColorPicker, FiberColorPickerProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.ColorPicker>,
...
export class FiberContainerPropsHandler implements PropsHandler<GUI.Container, FiberContainerProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Container>,
...
export class FiberEllipsePropsHandler implements PropsHandler<GUI.Ellipse, FiberEllipseProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Ellipse>,
...
export class FiberGridPropsHandler implements PropsHandler<GUI.Grid, FiberGridProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Grid>,
...
export class FiberStackPanelPropsHandler implements PropsHandler<GUI.StackPanel, FiberStackPanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.StackPanel>,
...
export class FiberVirtualKeyboardPropsHandler implements PropsHandler<GUI.VirtualKeyboard, FiberVirtualKeyboardProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.VirtualKeyboard>,
...
export class FiberRectanglePropsHandler implements PropsHandler<GUI.Rectangle, FiberRectangleProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Rectangle>,
...
export class FiberButtonPropsHandler implements PropsHandler<GUI.Button, FiberButtonProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Button>,
...
export class FiberSelectionPanelPropsHandler implements PropsHandler<GUI.SelectionPanel, FiberSelectionPanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.SelectionPanel>,
...
export class FiberImagePropsHandler implements PropsHandler<GUI.Image, FiberImageProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Image>,
...
export class FiberInputTextPropsHandler implements PropsHandler<GUI.InputText, FiberInputTextProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.InputText>,
...
export class FiberInputPasswordPropsHandler implements PropsHandler<GUI.InputPassword, FiberInputPasswordProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.InputPassword>,
...
export class FiberLinePropsHandler implements PropsHandler<GUI.Line, FiberLineProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Line>,
...
export class FiberMultiLinePropsHandler implements PropsHandler<GUI.MultiLine, FiberMultiLineProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.MultiLine>,
...
export class FiberRadioButtonPropsHandler implements PropsHandler<GUI.RadioButton, FiberRadioButtonProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.RadioButton>,
...
export class FiberTextBlockPropsHandler implements PropsHandler<GUI.TextBlock, FiberTextBlockProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.TextBlock>,
...
export class FiberSliderPropsHandler implements PropsHandler<GUI.Slider, FiberSliderProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Slider>,
...
export class FiberDisplayGridPropsHandler implements PropsHandler<GUI.DisplayGrid, FiberDisplayGridProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.DisplayGrid>,
...
export class FiberControl3DPropsHandler implements PropsHandler<GUI.Control3D, FiberControl3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Control3D>,
...
export class FiberAbstractButton3DPropsHandler
  implements PropsHandler<GUI.AbstractButton3D, FiberAbstractButton3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.AbstractButton3D>,
...
export class FiberButton3DPropsHandler implements PropsHandler<GUI.Button3D, FiberButton3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Button3D>,
...
export class FiberHolographicButtonPropsHandler
  implements PropsHandler<GUI.HolographicButton, FiberHolographicButtonProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.HolographicButton>,
...
export class FiberMeshButton3DPropsHandler implements PropsHandler<GUI.MeshButton3D, FiberMeshButton3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.MeshButton3D>,
...
export class FiberContainer3DPropsHandler implements PropsHandler<GUI.Container3D, FiberContainer3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.Container3D>,
...
export class FiberStackPanel3DPropsHandler implements PropsHandler<GUI.StackPanel3D, FiberStackPanel3DProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.StackPanel3D>,
...
export class FiberVolumeBasedPanelPropsHandler
  implements PropsHandler<GUI.VolumeBasedPanel, FiberVolumeBasedPanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.VolumeBasedPanel>,
...
export class FiberCylinderPanelPropsHandler implements PropsHandler<GUI.CylinderPanel, FiberCylinderPanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.CylinderPanel>,
...
export class FiberPlanePanelPropsHandler implements PropsHandler<GUI.PlanePanel, FiberPlanePanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.PlanePanel>,
...
export class FiberScatterPanelPropsHandler implements PropsHandler<GUI.ScatterPanel, FiberScatterPanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.ScatterPanel>,
...
export class FiberSpherePanelPropsHandler implements PropsHandler<GUI.SpherePanel, FiberSpherePanelProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.SpherePanel>,
...
export class FiberGUI3DManagerPropsHandler implements PropsHandler<GUI.GUI3DManager, FiberGUI3DManagerProps> {
  getPropertyUpdates(
    createdInstance: CreatedInstance<GUI.GUI3DManager>,
